...
import org.aesy.musicbrainz.entity.AreaList;
...
/* package-private */ final class MusicBrainzAreaBrowseRequestImpl
    extends MusicBrainzBrowseRequestImpl<DefAreaElementInner>
    implements MusicBrainzAreaBrowseRequest {
    ...
    /* package-private */ MusicBrainzAreaBrowseRequestImpl(
    ...
    @NotNull
    @Override
    public MusicBrainzAreaBrowseRequest include(@NotNull String... include) {
        // TODO
    ...
    @NotNull
    @Override
    protected List<DefAreaElementInner> mapResponse(@NotNull Response response)
        ...
        AreaList areaList = metadata.getAreaList();

        if (areaList == null) {
            throw new MusicBrainzEntityMappingException("Area list is null");
        }

        List<DefAreaElementInner> area = areaList.getArea();
