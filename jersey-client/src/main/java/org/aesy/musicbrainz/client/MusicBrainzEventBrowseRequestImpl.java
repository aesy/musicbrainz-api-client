...
import org.aesy.musicbrainz.entity.EventList;
...
/* package-private */ final class MusicBrainzEventBrowseRequestImpl
    extends MusicBrainzBrowseRequestImpl<Event>
    implements MusicBrainzEventBrowseRequest {
    ...
    /* package-private */ MusicBrainzEventBrowseRequestImpl(
    ...
    @NotNull
    @Override
    public MusicBrainzEventBrowseRequest include(@NotNull String... include) {
        // TODO
    ...
    @NotNull
    @Override
    protected List<Event> mapResponse(@NotNull Response response)
        ...
        EventList eventList = metadata.getEventList();

        if (eventList == null) {
            throw new MusicBrainzEntityMappingException("Event list is null");
        }

        List<Event> event = eventList.getEvent();
