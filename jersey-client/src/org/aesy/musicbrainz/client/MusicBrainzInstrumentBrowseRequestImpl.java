...
import org.aesy.musicbrainz.entity.InstrumentList;
...
/* package-private */ final class MusicBrainzInstrumentBrowseRequestImpl
    extends MusicBrainzBrowseRequestImpl<Instrument>
    implements MusicBrainzInstrumentBrowseRequest {
    ...
    /* package-private */ MusicBrainzInstrumentBrowseRequestImpl(
    ...
    @NotNull
    @Override
    public MusicBrainzInstrumentBrowseRequest include(@NotNull String... include) {
        // TODO
    ...
    @NotNull
    @Override
    protected List<Instrument> mapResponse(@NotNull Response response)
        ...
        InstrumentList instrumentList = metadata.getInstrumentList();

        if (instrumentList == null) {
            throw new MusicBrainzEntityMappingException("Instrument list is null");
        }

        List<Instrument> instrument = instrumentList.getInstrument();
